...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  return [{ title: data?.lanName + " - Bracket du tournoi " + data?.tournament.properties.name }]
}
...
export default function TournamentBracket() {
  ...
  useEffect(() => {
    ...
    html.classList.add("is-relative")
    ...
    if (htmlWidth > mainDivWidth) {
      body.classList.add("is-full-width", "is-flex", "justify-center")
    }
  })

  return (
    <div className="p-4 is-flex is-relative has-background-primary-level">
