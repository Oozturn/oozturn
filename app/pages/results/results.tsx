...
export default function Results() {
  ...
  return (
    <div className="is-full-height is-flex m-0 p-3 justify-center">
      <div
        className={`is-flex gap-2 justify-center ${["is-three-fifths", "is-four-fifths", "grow"][Number(lan.showTeamsResults) + Number(lan.showAchievements)]}`}
      >
        <PlayersLeaderboard />
...
function ResultTile({ place, user, teamName, stats, showInfo }: ResultPlayerTileProps) {
  ...
  return (
    <div
      className={`resultTile is-relative is-unselectable is-flex-col is-clipped has-background-primary-level pr-1 no-shrink ${teamName ? "is-clickable teamResult" : ""}`}
