...
export const modesList: Mode[] = [
    { name: "Dark", primary: "#333539", secondary: "#4B4C50", text: "#FFFFFF", genericGame: 'url(/genericGameDark.webp)' },
    { name: "Light", primary: "#E5E5E5", secondary: "#F9F9F9", text: "#3A3A3A", genericGame: 'url(/genericGameLight.webp)' },
]
