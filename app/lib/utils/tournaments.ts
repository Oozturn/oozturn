...
export function canEditScore(match: Match, opponentId: string | undefined, tournament: TournamentFullData, user: User, allopponentScoreSetting: boolean | "duel_only") {
